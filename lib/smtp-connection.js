...
var prototype = {
    ...
    _getAuthenticationObject: function (connectionOptions, options) {
        return Promise.bind(this).then(function () {
            ...
            return this.acquireResource(user, credentialsResourceName, credentials)
    ...
    invoke: function invoke(resourceId, email, options) {
        ...
        return Promise
            .bind(this).props({
                ...
                email: Promise.resolve(email).tap(this._opts.prepareEmail)
            })
            .then(function (data) {
